    ...
    <section>
      ...
      <div className="py-6 px-15 container mx-auto">
        ...
        <p className="text-gray-600 mb-4">
          Total Research: {myresearchData.length}
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {myresearchData.map((item) => {
            // Tentukan kelas berdasarkan status
            const key = item.status?.toLowerCase() || "default";
            const { bg, text } = statusClasses[key] || statusClasses.default;
                ...
                <div className="flex-1 flex flex-col justify-between">
                  ...
                  <div className="grid grid-cols-2 text-sm text-gray-700 mb-4">
                    <div>
                      ...
                      <span
                        className={`${bg} ${text} px-5 py-1 rounded-full text-md`}
                      >
                        {item.status || "-"}
                      </span>
                    </div>
